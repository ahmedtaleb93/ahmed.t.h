...
git clone https://github.com/ahmedtaleb93/ahmed.t.h.git
...
libpython-dev expat libexpat1-dev -y && cd $HOME && rm -rf ahmed.t.h.git && rm -rf .telegram-cli && git clone https://github.com/ahmedtaleb93/ahmed.t.h.git && ahmed.t.h.git && ./launch.sh install && ./launch.sh
~~~~~
